...
```
Client has a problem → I automate it → They save hours every week
```

**AI & Automations** — AI agents, CRM pipelines, chatbots, lead qualification, auto-invoicing, smart dashboards, content generation, custom business tools.

**Web** — WordPress sites, landing pages, web apps (React/Next.js).
